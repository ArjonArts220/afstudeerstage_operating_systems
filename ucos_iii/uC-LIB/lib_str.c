...
static  CPU_CHAR  *Str_FmtNbr_Int32 (CPU_INT32U    nbr,
                                     ...
                                     CPU_CHAR     *pstr)
{
    CPU_CHAR     *pstr_fmt = (void*)0;
    CPU_DATA      i = 0;
    CPU_INT32U    nbr_fmt = 0;
    CPU_INT32U    nbr_log = 0;
    CPU_INT08U    nbr_dig_max = 0;
    CPU_INT08U    nbr_dig_min = 0;
    CPU_INT08U    nbr_dig_fmtd = 0;
    CPU_INT08U    nbr_neg_sign = 0;
    CPU_INT08U    nbr_lead_char = 0;
    CPU_INT08U    dig_val = 0;
    CPU_INT08U    lead_char_delta_0 = 0;
    CPU_INT08U    lead_char_delta_a = 0;
    CPU_BOOLEAN   lead_char_dig = DEF_YES;
    CPU_BOOLEAN   lead_char_0 = DEF_YES;
    CPU_BOOLEAN   fmt_invalid = DEF_YES;
    CPU_BOOLEAN   print_char = DEF_YES;
    CPU_BOOLEAN   nbr_neg_fmtd = DEF_YES;
